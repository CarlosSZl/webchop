...
<%
 ...
 List<beanProducto> productosList = (List<beanProducto>) request.getSession().getAttribute("productos");
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" style="font-weight: bold; cursor: pointer;" href="index.html">Home</a>
                </li>
                <!--
                <li class="nav-item ">
 ...
 %>
            ...
            <div class="card" style="width: 46%;  margin-left: 50px; display: inline-block;">
                <img class="card-img-top" src="img/<%= producto.getImg()%>" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title"><%= producto.getNombre()%></h5>
                    <p class="card-text"><%= producto.getPrecio()%></p>
                    <a href="sProductos?prod=<%= producto.getProductoID()%>" class="btn btn-primary">Aguegar al carro</a>
                </div>
            </div>
<% }%>
